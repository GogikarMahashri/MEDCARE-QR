  ...
  return (
    <div className="w-full p-1">
      <Card className="w-full overflow-hidden">
        ...
        <CardContent className="flex flex-col sm:flex-row items-center justify-around gap-8 p-6 md:p-10">
          <div className="flex flex-col items-center gap-2 text-center">
            <Camera className="w-12 h-12 text-primary" />
            <span className="text-sm font-semibold">Scan QR</span>
            <p className="text-xs text-muted-foreground max-w-[150px]">Quick access to medical history.</p>
          </div>
          <QrCodeWithAnimation />
          <div className="flex flex-col items-center gap-2 text-center">
